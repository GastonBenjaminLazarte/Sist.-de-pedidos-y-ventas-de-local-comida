...
function bindButtons() {
  const newOrderButton = document.getElementById('btnNuevoPedido');
  if (newOrderButton) {
  ...
  const employeeLoginButton = document.getElementById('btnEmployeeLogin');
  if (employeeLoginButton) employeeLoginButton.addEventListener('click', () => {
  ...
  const deliveryLoginButton = document.getElementById('btnDeliveryLogin');
  if (deliveryLoginButton) deliveryLoginButton.addEventListener('click', () => {
